...
abstract class AbstractElement
{
     ...
     * Should return a single DOM instance holding all of the markup.
     *
     ...
     * (by the inherited element) content.
     *
     * Call resetDecorators() between each call to render().
     *
     ...
     * @return HtmlPageCrawler
     */
    protected function decorate($callerClassName, HtmlPageCrawler $render, array $parents = [])
    {
